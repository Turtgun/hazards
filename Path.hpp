...
class Path {
    ...
    public:
        ...
        void createPath(Vector2* _pPoints, unsigned short _n) {
            pPoints = _pPoints; n = _n;
            for (unsigned short i = 0; i < n; i++) {
                pPoints[i]=pPoints[i]/Vector2(inchesPerTick, inchesPerTick);
            }
            ...
            nPoints = smoother(nPoints, 0.1, 0.3, 0.0000001);
